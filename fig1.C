...

{
  ...
  gPad->SetLogy(1);
  copy->SetTitle("Simulated Spill Normal Behaviour;Time in Spill            (ms); Protons per Pulse");
  text->DrawText( 15.,  3000000, "Mean protons per pulse: 40.5 Mp");
