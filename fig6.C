...

{
  ...
  //std::string base_filename = "Pathological";
  ...
  double mean=38.6*0.9;   // protons per pulse
  ...
  copy->SetTitle("Simulated Spill (Pathological);Time in Spill         (ms); Reco ExtMon Tracks");
  copy->SetMinimum(0.);
  copy->SetMaximum(400.);
  ...
  line->DrawLine( t0, mean, tend, mean);
  copy->SetTitle("Simulated Spill (Pathological) Every 25th Pulse;Time in Spill         (ms); Reco ExtMon Tracks");
  copy->SetMinimum(0.);
  copy->SetMaximum(400.);
  ...
  line->DrawLine( t0, mean, tend, mean);
  copy->SetTitle("Simulated Spill (Pathological) Every 50th Pulse;Time in Spill         (ms); Reco ExtMon Tracks");
  copy->SetMinimum(0.);
  copy->SetMaximum(400.);
  ...
  line->DrawLine( t0, mean, tend, mean);
  copy->SetTitle("Simulated Spill (Pathological) Every 100th Pulse;Time in Spill            (ms); Reco ExtMon Tracks");
  copy->SetMinimum(0.);
  copy->SetMaximum(400.);

  canvas->Print("fig6.png");
